...
using HCP.Localization.WebAPI.Utility;
using Newtonsoft.Json.Serialization;
using DL_Localization = HCP.Localization.DL.Entities;
using HCP.Localization.IF;
using HCP.Localization.DL.Repository;
using HCP.Localization.DL.Entities;
using Microsoft.EntityFrameworkCore;

namespace HCP.Localization.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            DL_Localization.eSyaEnterprise._connString = Configuration.GetConnectionString("dbConn_eSyaEnterprise");
